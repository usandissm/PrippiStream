...
def set_player(item, xlistitem, mediaurl, view, strm):
    ...
    # If it is a strm file, play is not necessary
        ...
        if player_mode in [0,1]:
            ...
            # v2 FASE 8c: rimossa add_next_to_playlist (accodava il prossimo
            # episodio SOLO per item con strm_path — file videolibrary, feature
            # morta; il next-episode Prippi è l'overlay di prippihome).
