...
- [ ] **FASE 10c** (OPZIONALE) — Estetica: angoli arrotondati card via diffuse mask + frame bordertexture (+ ~-120 controlli). Richiede iterazione VISIVA su Kodi PC → farla quando si può guardare lo schermo
