...
PrippiStream, alla fine, non è altro che un browser che estrapola dai siti le info richieste secondo regole ben precise, basate sulla struttura dei siti.<br>
...
Prima di segnalare un problema assicurati che sia realmemte legato a PrippiStream, sotto alcuni requisiti necessari:
- avere l'ultima versione di PrippiStream, per controllare vai qui e confronta il numero con quello presente nella sezione aiuto: https://github.com/usandissm/PrippiStream/commits/stable
...
Puoi fare tutte le segnalazioni nella sezione [issues](https://github.com/usandissm/PrippiStream/issues), cliccando su "new issue" appariranno dei template che ti guideranno nel processo.
...
Verrà preso in considerazione il prima possibile ed eventualmente inserito nella [wiki](https://github.com/usandissm/PrippiStream/wiki).

# Consigli
Effettuali sempre nella sezione [issues](https://github.com/usandissm/PrippiStream/issues), miraccomando descrivi e fai esempi pratici.<br>
...
Un buon punto di partenza è [la wiki](https://github.com/usandissm/PrippiStream/wiki), qui è presente un minimo di documentazione sul funzionamento di PrippiStream.<br>
...
Questo perchè, oltre al fatto di poter iniziare a mandare modifiche sul tuo account github, l'utilizzo di git abilita la [dev mode](https://github.com/usandissm/PrippiStream/wiki/dev-mode), che ti sarà di aiuto nelle tue attività.

## che cosa posso fare?
Puoi provare a fixare un bug che hai riscontrato, aggiungere un canale/server che ti interessa ecc..
Oppure puoi guardare nella sezione [Projects](https://github.com/usandissm/PrippiStream/projects) cosa è previsto e iniziare a svilupparlo!
